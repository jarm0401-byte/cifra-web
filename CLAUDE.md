# CLAUDE.md — aviso para Claude Code

Bienvenido de vuelta. Este repo ahora es un taller compartido entre dos motores de IA
que trabajan para Angel (dueño de CIFRA): tú (Claude Code) y OpenCode.
